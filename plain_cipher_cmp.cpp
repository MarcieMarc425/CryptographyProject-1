// cipher_num is the array of numbers between 0 to 105 which occur x times in the ciphertext.
...
int plain_cipher_cmp(int cipher_num[], string ciphertext, string plaintext[]){
...
int main(){
	...
	plaintext_num = plain_cipher_cmp(cipher_num, ciphertext, plaintext);
